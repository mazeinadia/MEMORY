...
import {SCORE_MULT, MIN_SCORE} from "../../../globals";
...
function closeOrDeleteCard(state, action) {
    ...
    let deletingEnabled = openedCards[0].cardName === openedCards[1].cardName;
    let newScore = calculateNewScore(state.score, deletingEnabled, state.cardPairsRestCount);
    let cardPairsRestCount = (deletingEnabled) ? (state.cardPairsRestCount - 1) : state.cardPairsRestCount;
